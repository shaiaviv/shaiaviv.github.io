...
export default function ProjectCard({ project, index, isDragging }: Props) {
      ...
      <div className="flex items-start justify-between mb-5 relative z-10">
        ...
        <div className="flex gap-3">
          <a href={project.repo} target="_blank" rel="noopener noreferrer"
            ...
            className="text-muted hover:text-text-1 transition-colors duration-200" aria-label="GitHub">
