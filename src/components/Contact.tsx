...
function MagneticLink({
  ...
  return (
    <motion.a
      ...
      className={
        primary
          ? 'px-8 py-4 bg-accent hover:bg-accent-hover text-white rounded-xl font-semibold text-sm glow-accent transition-colors duration-200 inline-block'
          : 'p-3.5 rounded-xl glass-card border border-white/[0.05] hover:border-accent/25 text-muted hover:text-text-1 transition-colors duration-200 inline-flex items-center justify-center'
      }
    >
      {children}
    </motion.a>
...
export default function Contact() {
  return (
    <section id="contact" className="py-36 px-6 relative overflow-hidden">
      ...
      >
        <span
          className="text-[20vw] font-black text-white/[0.018] tracking-tighter leading-none"
